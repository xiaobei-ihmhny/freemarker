 ...
 * @date 2017-06-25 7:37
 * @description 与JavaBean相关的操作，主要负责生成相应的属性和方法
 */
public class JavaBeanUtils {
    ...
    public static void main(String[] args) {
        System.out.println(JavaBeanUtils.toUnderlineString("ISOCertifiedStaff"));
        System.out.println(JavaBeanUtils.getValidPropertyName("CertifiedStaff"));
        System.out.println(JavaBeanUtils.getSetterMethodName("userID"));
        System.out.println(JavaBeanUtils.getGetterMethodName("userID"));
        System.out.println(JavaBeanUtils.toCamelCaseString("iso_certified_staff", true));
        System.out.println(JavaBeanUtils.getValidPropertyName("certified_staff"));
        System.out.println(JavaBeanUtils.toCamelCaseString("site_Id"));
    }
