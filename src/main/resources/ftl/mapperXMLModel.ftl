...
<resultMap id="${className}Map" type="${pojo_packageName}.${className}">
    ...
    <!--全部插入-->
    <insert id="insert" parameterType="${pojo_packageName}.${className}" >
    ...
    <!--部分字段插入-->
    <insert id="insertSelective" parameterType="${pojo_packageName}.${className}" >
        INSERT INTO ${tableName}
    ...
    <!-- 根据主键查询 -->
    <select id="selectById" resultType="${pojo_packageName}.${className}" parameterType="java.lang.Integer" >
        SELECT
        <include refid="Base_Column_List" />
        FROM ${tableName}
        WHERE
	...
	<!--部分字段更新-->
	<update id="updateById" parameterType="${pojo_packageName}.${className}" >
		UPDATE ${tableName}
		<set >
			<#list properties as pro>
			<#if pro.columnName!="id">
	...
	<!-- 查询 -->
	<select id="selectByParams" parameterType="${vo_packageName}.${voClassName}" resultType="${pojo_packageName}.${className}">
		SELECT
		<include refid="Base_Column_List" />
		FROM ${tableName}
        <where>
