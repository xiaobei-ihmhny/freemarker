...
public class CodeMeachine {
	...
	/**
	 * 根据数据库表生成相应的Pojo
	 * @param generateFilePath 生成pojo文件的位置
	 ...
	 * @param fileName 文件名
	 */
	public static void generatePojo(String generateFilePath, String templateName, String tableName, char fieldSeparator, String packageName,String className,String fileName){
